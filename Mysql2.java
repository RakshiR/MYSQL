...
public class Mysql2 {
  ...
  static final String DB_URL = "jdbc:mysql://localhost/rakshi?autoReconnect=true&useSSL=false";
...
public static void main(String[] args) {
  ...
  try{
     ...
     statement.setString(2, "RAKSHI");
     statement.setString(3, "rakshi123@gmail.com");
